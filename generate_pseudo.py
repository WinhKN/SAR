...
from sklearn.metrics.pairwise import euclidean_distances, cosine_distances, pairwise_distances, pairwise_distances_argmin
...
def agglomerative_clustering(stamps, features, classes, metric='euclidean', tol=1e-4):
    ...
    model = AgglomerativeClustering(n_clusters=n, metric='precomputed', connectivity=connectivity, linkage='average', compute_distances=True).fit(dist_matrix)
